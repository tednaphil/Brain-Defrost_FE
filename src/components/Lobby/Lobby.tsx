import './Lobby.css';
import type { Player, ServerToClientEvents, ClientToServerEvents } from '../Util/interfaces';
...
function Lobby({players}: Props) {
    ...
    useEffect(() => {
        ...
        setJoinUrl(`https://https://brain-defrost.netlify.app/join/${gameid}/?data=${encodedQuestion}`)
        // @ts-expect-error
